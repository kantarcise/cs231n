...
def affine_activation_normalize_dropout_forward(x, w, b, 
                                                gamma=None, 
                                                beta=None, 
                                                bn_param=None, 
                                                dropout_param=None,
    ...
    """Template forward that applies affine forward together with 
    BN, ReLU, and dropout if needed.
    ...
    - last: In the last layer, we will just apply affine forward.
    ...
    if not last:
        ...
        # perform relu in every case
        out, relu_cache = relu_forward(out) 

        # Apply dropout if we are given its parameters
...
def affine_activation_normalize_dropout_backward(dout, cache):
    """Template backward that applies affine backwards together with 
    BN, ReLU, and dropout backwards if needed.
    """
    ...
    # Affine backward always applied
